...
survey.createModel('{"title":"Title","description":"Description","pages":[{"id":1,"title":"TitlePages","description":"PagesDescription","panels":[{"id":1,"title":"TitlePanels","description":"PanelsDescription","columns":1,"questions":[{"id":1,"title":"QuestionText","type":"Text"},{"id":2,"title":"QuestionChoice","type":"Choice","choices":[{"id":1,"label":"Ch_1","checked":false,"disabled":false},{"id":2,"label":"Ch_2","checked":false,"disabled":false}]}]}]}]}');
console.log(survey);
