...
import { Checkbox, DefaultButton, Dropdown, FocusZone, FocusZoneDirection, IDropdownOption, List, ScrollToMode, TextField, css } from '@fluentui/react';
...
export class ListScrollingExample extends React.Component<IListScrollingExampleProps, IListScrollingExampleState> {
  private _list: List<IExampleItem> | undefined;
